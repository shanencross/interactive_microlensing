...
function plot_binary() {
    ...
    var cof1 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0.1;
    var cof2 = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : -0.5;
    var minXLM = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : -3;
    var maxXLM = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 3;
    var NPN = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 40;
    var NR = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : 30000;
    var DR = arguments.length > 9 && arguments[9] !== undefined ? arguments[9] : 0.0001;
    var timeDebug = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : false;
    ...
    */
    ...
    for (var IXS = 0; IXS < NXS; IXS++) {
        ...
        var imageparms = bin_ima.bin_ima(GM1, GM2, D, XS[IXS], YS[IXS]);
        var transposed_imageparms = math.transpose(imageparms);
...
function findCausticAndCritCurves() {
    var GM1 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.5;
    var GM2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.5;
    var D = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0.5;
    var NR = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 30000;
    var DR = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0.0001;
    ...
    if (NR !== undefined && NR !== null && NR !== NaN && (DR === undefined || DR === null || DR === NaN)) {
        DR = 3.0 / NR;
    }
    ...
    for (var IQ = 0; IQ < 2; IQ++) {
        ...
        // ```
        var B_paren2 = numeric.sub(numeric.mul(GMXM, R2), numeric.mul(B_paren1, R4M));
        // ```
        // 8 * R * D * (B_paren2)
        // ```
        var B = numeric.mul(8 * D, numeric.mul(R, B_paren2));
        ...
        // ```
        var C_part1 = numeric.sub(numeric.mul(C_paren1, R4M), numeric.mul(GM1S, R4));
        // ```
        // 2 * GMXM * R2 * (C_paren2)
        // ```
        var C_part2 = numeric.mul(2 * GMXM, numeric.mul(R2, C_paren2));
        // ```
        // C_part1 - C_part2
        // ```
        ...
        // DT = B * B - 4 * A * C
        // ```
        var DT = numeric.sub(numeric.mul(B, B), numeric.mul(4, numeric.mul(A, C)));
