...
function initLenses() {
  ...
  var ring1radius_mas = eventModule.calculateThetaE(true, false, 1);
  ...
  var ring2radius_mas = eventModule.calculateThetaE(true, false, 2);
...
var drawing = function () {
  ...
  function convertLensedImagesPos() {
    ...
    var imagesPos = new Array(imageCount);
    var imagesPixelPos = new Array(imageCount);
